...
import app.dev.myapplication.databinding.ActivityWebBinding;


public class WebActivity extends AppCompatActivity implements MyWebview.Listener, View.OnClickListener {
